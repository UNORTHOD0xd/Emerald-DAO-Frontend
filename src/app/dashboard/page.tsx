...
export default function Dashboard() {
  const { 
    address, 
    balance,        // Already formatted string from hook
    votingPower,    // Already formatted string from hook
    treasuryBalance, // Already formatted string from hook
    healthScore,
    isLoading,
    isDAOMember,
    canVote,
